...
<head>
    ...
    <link rel="stylesheet" href="/assets/user-assets/css/feather.css">
    <!-- Favicon icon -->
    <link rel="icon" type="/assets/user-assets/image/png" sizes="16x16" href="images/favicon.png">
    <!-- Custom Stylesheet -->
    <link rel="stylesheet" href="/assets/user-assets/css/style.css">
    <link rel="stylesheet" href="/assets/user-assets/css/custom-style.css"> 
    <link rel="stylesheet" href="/assets/user-assets/css/emoji.css">
    
    <link rel="stylesheet" href="/assets/user-assets/css/lightbox.css">
...
<body class="color-theme-blue mont-font">
    ...
    <div class="main-wrapper">
        ...
        <div class="nav-header bg-white shadow-xs border-0">
            <div class="nav-top">
                <a href="index.html"><i class="feather-zap text-success display1-size me-2 ms-0"></i><span class="d-inline-block fredoka-font ls-3 fw-600 text-current font-xxl logo-text mb-0">MNTI. </span> </a>
                ...
                <div class="nav-content">
                    <div class="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2 mt-2">
                        ...
                        <ul class="mb-1 top-content">
                             <li><a href="/feeds" class="nav-content-bttn open-font" ><i class="feather-tv btn-round-md bg-blue-gradiant me-3"></i><span>Newsfeed</span></a></li>
                            ...
                            <li><a href="/alumni/directory" class="nav-content-bttn open-font" ><i class="feather-globe btn-round-md bg-gold-gradiant me-3"></i><span>Directory</span></a></li>
                            <li><a href="default-group.html" class="nav-content-bttn open-font" ><i class="feather-zap btn-round-md bg-mini-gradiant me-3"></i><span>Professor</span></a></li>
                            <li><a href="/alumni/profile" class="nav-content-bttn open-font"><i class="feather-user btn-round-md bg-primary-gradiant me-3"></i><span>Profile </span></a></li>     
                        </ul>
                    </div>
                    ...
                    <div class="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2">
                        ...
                        <ul class="mb-3">
                            ...
                            <li><a href="default-hotel.html" class="nav-content-bttn open-font"><i class="font-xl text-current feather-home me-3"></i><span>Near By Alumni</span></a></li>
...
{{--                             <li><a href="default-live-stream.html" class="nav-content-bttn open-font"><i class="font-xl text-current feather-youtube me-3"></i><span>Live Stream</span></a></li>                        
 --}}                        </ul>
    ...
    @csrf
    <button type="submit" class="btn btn-outline-danger w-100 d-flex align-items-center justify-content-center gap-2" aria-label="{{ __('Log Out') }}">
        {{-- example logout SVG (Heroicons-style) --}}
...
{{ $slot }}
                        ...
                        <div class="col-xl-4 col-xxl-3 col-lg-4 ps-lg-0">
                            ...
                            <div class="card w-100 shadow-xss rounded-xxl border-0 mb-3">
                                ...
                                <div class="card-body d-flex pt-4 ps-4 pe-4 pb-0 overflow-hidden border-top-xs bor-0">
                                    <img src="images/g-2.html" alt="img" class="img-fluid rounded-xxl mb-2">
                                </div>
                                ...
                                <div class="card-body d-flex pt-0 ps-4 pe-4 pb-0 overflow-hidden">
                                    <img src="images/g-3.html" alt="img" class="img-fluid rounded-xxl mb-2 bg-lightblue">
                                </div>
                                <div class="card-body d-flex align-items-center pt-0 ps-4 pe-4 pb-4">
                                    <a href="#" class="p-2 lh-28 w-100 bg-grey text-grey-800 text-center font-xssss fw-700 rounded-xl"><i class="feather-external-link font-xss me-2"></i> Like Page</a>
                                </div>
        ...
        <div class="app-footer border-0 shadow-lg bg-primary-gradiant">
            ...
            <a href="default-settings.html" class="nav-content-bttn"><img src="images/female-profile.html" alt="user" class="w30 shadow-xss"></a>
        </div>
                ...
                <div class="modal-body p-0">
                    <div class="card w-100 border-0 rounded-3 overflow-hidden bg-gradiant-bottom bg-gradiant-top">
                        <div class="owl-carousel owl-theme dot-style3 story-slider owl-dot-nav nav-none">
                            <div class="item"><img src="images/story-5.html" alt="image"></div>
                            <div class="item"><img src="images/story-6.html" alt="image"></div>
                            <div class="item"><img src="images/story-7.html" alt="image"></div>
                            <div class="item"><img src="images/story-8.html" alt="image"></div>
                            
                        </div>
                    </div>
                    <div class="form-group mt-3 mb-0 p-3 position-absolute bottom-0 z-index-1 w-100">
                        <input type="text" class="style2-input w-100 bg-transparent border-light-md p-3 pe-5 font-xssss fw-500 text-white" value="Write ii ii Comments">               
    ...
    <script src="/assets/user-assets/js/plugin.js"></script>
     <script src="https://unpkg.com/feather-icons"></script>
    <script src="/assets/user-assets/js/lightbox.js"></script>
    <script src="/assets/user-assets/js/scripts.js"></script>

    <script>
    document.addEventListener('livewire:initialized', () => {
        Livewire.on('showStoryModal', () => {
            const modalEl = document.getElementById('Modalstory');
            if (modalEl) {
                const modal = new bootstrap.Modal(modalEl);
                modal.show();

                // Re-init owl only if needed
                $(modalEl).find('.story-slider').owlCarousel({
                    items: 1,
                    loop: true,
                    dots: true,
                    nav: false,
