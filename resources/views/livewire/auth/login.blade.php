<div class="max-w-md mx-auto p-6 bg-white rounded shadow">
    ...
    <div class="form-group icon-input mb-3">
        ...
        <input
            ...
            class="style2-input ps-5 form-control text-grey-900 font-xsss fw-600 @error('identifier') is-invalid @enderror"
    ...
    <div class="form-check text-left mb-3">
        <input
            ...
            id="rememberCheck"
        >
        <label class="form-check-label font-xsss text-grey-500" for="rememberCheck">Remember me</label>

        <a href="{{ route('password.request') ?? 'forgot.html' }}" class="fw-600 font-xsss text-grey-700 mt-1 float-right">
